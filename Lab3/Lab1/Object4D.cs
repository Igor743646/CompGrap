...
namespace Geometry
{
    public class Object4D
    {
        ...
        public Object4D(Point4D[] points, Polygon4D[] polygons, SolidColorBrush brush) : this(points, polygons)
        {
            Material = new Material
            {
                Color = brush,
        ...
        public Object4D(Point4D[] points, Polygon4D[] polygons, Material m) : this(points, polygons)
        {
            Material = m;
        }
